...
const QUERIES = [
	...
	['forging', 'cardano_node_metrics_forging_enabled_int{alias=~"cn.m.bp.*"}'],
	['kes', 'cardano_node_metrics_remainingKESPeriods_int{alias=~"cn.m.bp.*"}'],
	['delay', 'cardano_node_metrics_blockfetchclient_blockdelay_real'],
	['cdf', 'cardano_node_metrics_blockfetchclient_blockdelay_cdfFive_real'],
	['mempool', 'cardano_node_metrics_txsInMempool_int'],
	['tx', 'cardano_node_metrics_txsProcessedNum_counter'],
	['outConns', 'cardano_node_metrics_connectionManager_outboundConns_int'],
	['inConns', 'cardano_node_metrics_connectionManager_inboundConns_int'],
	['peers', 'cardano_node_metrics_peerSelection_Hot_int'],
